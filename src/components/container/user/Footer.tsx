export default function Footer() {
  return (
    <section className='w-full border-t border-[#D5D7DA]'>
      <div className='custom-container my-80 flex h-auto w-full flex-col place-content-center items-center justify-center'>
        {/* Booky */}
